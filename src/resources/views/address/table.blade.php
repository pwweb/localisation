    ...
    <table class="table table-striped" id="addresses-table">
        ...
        @foreach($addresses as $address)
            <tr>
                ...
                <td>
                    {!! Form::open(['route' => ['localisation.address.destroy', $address->id], 'method' => 'delete']) !!}
                    <div class='btn-group'>
                        <a href="{{ route('localisation.address.show', [$address->id]) }}" class='btn btn-ghost-success'><i class="fa fa-eye"></i></a>
                        <a href="{{ route('localisation.address.edit', [$address->id]) }}" class='btn btn-ghost-info'><i class="fa fa-edit"></i></a>
